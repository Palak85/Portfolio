  ...
  return (
    <section id="contact" className="py-24 px-10 md:px-24 bg-tertiary/10">
      ...
      <div className="text-center mb-20">
        <h2 className="text-5xl font-bold">Let's <span className="text-emerald-500 italic">Connect</span></h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto mb-20">
        ...
        <div className="flex flex-col justify-center">
          <h3 className="text-2xl font-bold mb-10">Reach Out</h3>
          ...
          <div className="mt-16">
            <p className="font-bold mb-6 text-secondary uppercase text-xs tracking-[0.2em]">Find me on</p>
            <div className="flex gap-6">
              <a href="https://www.linkedin.com/in/palak-kumari/" target="_blank" className="p-4 bg-tertiary rounded-2xl border border-white/5 hover:border-accent hover:text-accent transition duration-300"><Linkedin /></a>
              <a href="https://github.com/Palak85" target="_blank" className="p-4 bg-tertiary rounded-2xl border border-white/5 hover:border-accent hover:text-accent transition duration-300"><Github /></a>
